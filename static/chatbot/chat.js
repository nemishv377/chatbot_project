...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let sessionId = localStorage.getItem("assistant_chat_session_id") || null;
    ...
    const startNewChat = () => {
        sessionId = null;
        localStorage.removeItem("assistant_chat_session_id");
        chatBox.innerHTML = "";
    };
    ...
    const loadChatHistory = async () => {
        ...
        try {
            const resp = await fetch(`/chatbot/assistant/${sessionId}/`, { method: "GET" });
    ...
    form.addEventListener("submit", async (e) => {
        ...
        input.disabled = true;
        try {
            const resp = await fetch(`/chatbot/assistant/${sessionId}/`, {
                method: "POST",
            ...
            if (resp.ok) {
                ...
                if (data.session_id) {
                    ...
                    localStorage.setItem("assistant_chat_session_id", sessionId);
                }
            } else {
